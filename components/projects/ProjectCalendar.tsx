// components/projects/ProjectCalendar.tsx
"use client";
...
export function ProjectCalendar({
  ...
  const canView = hasPermission(userPermissions, "calendar:view");
  const canEditDates = hasPermission(userPermissions, "calendar:edit_dates");
  const canEditWorkplan =
    canEditDates && checklistStatus === "WeightsAssignment";
