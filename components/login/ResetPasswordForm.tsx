...
import { ResetPasswordActionState } from "@/lib/types/loginTypes";
import resetPasswordHandler from "@/lib/actions/loginActions";
        ...
        <div className="p-8">
          ...
          {isSuccess ? (
            <div className="text-center py-12">
              <CheckCircle className="mx-auto text-green-500 dark:text-green-400 text-5xl mb-4" />
            ...
            <>
              ...
              <div className="text-center mb-8">
                <div className="mx-auto w-16 h-16 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center mb-4">
                  <Lock className="w-8 h-8 text-green-500 dark:text-green-700" />
                </div>
