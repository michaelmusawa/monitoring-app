...
// Import trackers and checklists data
import { trackers, checklists } from "@/lib/data/data";
// Import checklist status enum - adjust based on your actual enum values
...
type Checklist = {
  id: string;
  projectId: string;
  status: string; // This is the checklist status from the checklists array
  items: any[];
  draftReview?: any;
  weightAssignment?: any;
};
...
const getProjectChecklistStatus = (
  projectId: string,
...
const getReviewType = (checklist: Checklist): string => {
