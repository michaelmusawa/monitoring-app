...
import { Mail, X, Key, CheckCircle, AlertCircle } from "lucide-react";
import { ForgotPasswordActionState } from "@/lib/types/loginTypes";
import { forgetPassword } from "@/lib/actions/loginActions";
            ...
            <div className="p-6">
              ...
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                  <div className="p-2 bg-green-100 dark:bg-green-900/30 rounded-lg">
                    <Key className="text-green-600 dark:text-green-400 text-xl" />
                  </div>
              ...
              {state.message && !state.state_error ? (
                <div className="text-center">
                  <CheckCircle className="mx-auto text-green-500 dark:text-green-400 text-4xl mb-4" />
                ...
                <>
                  ...
                  {state.state_error && (
                    <div className="mb-6 p-3 bg-red-50 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-lg flex items-start gap-3">
                      <AlertCircle className="flex-shrink-0 text-red-500 dark:text-red-400 text-xl" />
                      <div>
